...
class ProfileTestClass(TestCase):
    #setUp method
    def setUp(self):
        self.mark=Profile(profile_name="mark", profile_photo="https://www.pexels.com/photo/person-holding-midnight-black-samsung-galaxy-s8-turn-on-near-macbook-pro-1092671/", bio="Person holding a galaxy phone")

    def test_instance(self):
        self.assertTrue(isinstance(self.mark, Profile))

    def test_save_method(self):
        self.mark.save_profile()
...
class ImageTestClass(TestCase):
    ...
    def setUp(self):
        self.mark=Profile(profile_name="mark", profile_photo="https://www.pexels.com/photo/person-holding-phone-while-logging-in-on-instagram-application-174938/", bio="Cool Cat")
        self.mark.save_profile()

        self.commentone=Comment(comment="Great Picture")
        self.commentone.save_comment()

        self.imageone=Image(image="https://www.pexels.com/photo/person-holding-phone-while-logging-in-on-instagram-application-174938/", image_name="Log into IG", caption="Man holding phone to log in to IG", profile=self.mark, comments=self.commentone, likes=4)
